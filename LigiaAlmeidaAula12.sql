-- Criar banco de dados da aula 12
create database bd_aula12;
...
SELECT fc_soma(123, 321) AS soma_teste;
...
SELECT fc_proj_departamento(4) AS total_projetos_departamento_4;
